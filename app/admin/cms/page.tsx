    ...
    <div className="mx-auto max-w-7xl p-8">
      ...
      <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
        ...
        <CMSCard
          ...
          icon={<Palette className="h-8 w-8" strokeWidth={2} />}
        />
        ...
        <CMSCard
          ...
          icon={<Home className="h-8 w-8" strokeWidth={2} />}
        />
        ...
        <CMSCard
          ...
          icon={<Phone className="h-8 w-8" strokeWidth={2} />}
        />
        ...
        <CMSCard
          ...
          icon={<Megaphone className="h-8 w-8" strokeWidth={2} />}
        />
        ...
        <CMSCard
          ...
          icon={<LayoutTemplate className="h-8 w-8" strokeWidth={2} />}
        />
        ...
        <CMSCard
          ...
          icon={<Search className="h-8 w-8" strokeWidth={2} />}
        />
        ...
        <CMSCard
          ...
          icon={<CircleHelp className="h-8 w-8" strokeWidth={2} />}
        />
        ...
        <CMSCard
          ...
          icon={<Settings className="h-8 w-8" strokeWidth={2} />}
        />
      </div>
    </div>
  );
